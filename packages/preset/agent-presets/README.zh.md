...
随附 Web 的 `s1mple-mode`、`anchored-standard`、`codex-v5`、`codex-v6`、`ptc`、`cordis` 与 `linx-mode` preset 包含[显式文件交付](../../client/ui-deliverables/README.zh.md#explicit-deliveries)。`anchored-standard` 在会话晋升前刻意只组合 bootstrap 工具对与发现工具。
