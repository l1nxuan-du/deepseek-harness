...
- **The composer carries no fade band** — the shipped composer seat fades the transcript into the page fill over 36px; the material chrome drops that band, so the input sits on the field directly.
