...
- **The composer seat is a flat surface, not a fade** — the shipped seat fades the transcript into the page fill over a 36px gradient; the material chrome replaces that with a flat mica surface, so nothing reads through behind the input and no gradient sits there.
