...
import { BashTerminalBackend, PWSH_LINE_EDITOR_SETUP, PWSH_PROMPT_SETUP } from '@deepseek-ai/dsh-terminal-bash'
...
describe('BashTerminalBackend startup rollback', () => {
  ...
  it('bootstraps a pwsh dialect through the prompt function and scrubs bash-only env', async () => {
    ...
    expect(sent).toMatchObject({
      text: ENCODING_PREAMBLE + PWSH_LINE_EDITOR_SETUP + PWSH_PROMPT_SETUP,
      submit: true,
    })
