...
flowchart LR
  ...
  plugin_dsh_base_tool_apply_patch["tool-apply-patch<br/>@deepseek-ai/dsh-tool-apply-patch"]
  cfg --> plugin_dsh_base_tool_apply_patch
...
| `tool-apply-patch` | `@deepseek-ai/dsh-tool-apply-patch` |
