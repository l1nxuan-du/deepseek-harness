...
!define INSTALLER_BUTTON_Y 522
!define INSTALLER_DESKTOP_OPTION_Y 466
!define INSTALLER_MENU_OPTION_Y 494
; Logical width of the drawn check box ahead of a checkbox label.
!define INSTALLER_CHECKBOX_GLYPH 28
